...
prompt_text = r'''
{
  ...
  "4": {
    "inputs": {
      "ckpt_name": "kohaku-xl-zeta.safetensors"
    },
  ...
  "35": {
    "inputs": {
      "vae_name": "Sharp-VAE-SDXL-Hard.safetensors"
    },
...
async def t2i(prompt, res):
    ...
    # 设置文本描述
    req["6"]["inputs"]["text"] = str(prompt).strip().rstrip(",") + ", (masterpiece,best quality,highres,absurdres:1.2), recent, newest"
