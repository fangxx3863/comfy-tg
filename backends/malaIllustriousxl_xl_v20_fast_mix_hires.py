...
prompt_text = r'''
{
  ...
  "4": {
    "inputs": {
      "ckpt_name": "malaIllustriousxl_v20.safetensors"
    },
...
async def t2i(prompt, res):
    ...
    # 设置文本描述
    req["6"]["inputs"]["text"] = str(prompt).strip().rstrip(",") + ", anime screencap, score_9, score_8_up, score_7_up, score_6_up, score_5_up, score_4_up, (very awa, masterpiece,best quality,ultra_detailed,highres,absurdres:1.2), year 2022, year 2023, year 2024, newest"
