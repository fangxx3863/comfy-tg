...
prompt_text = r'''
{
  ...
  "4": {
    "inputs": {
      "ckpt_name": "Illustrious-XL-v1.0.safetensors"
    },
  ...
  "7": {
    "inputs": {
      "text": "(overfit style:18), (worst quality, low quality, ugly:1.4), poorly drawn hands, poorly drawn feet, poorly drawn face, out of frame, mutation, mutated, extra limbs, extra legs, extra arms, disfigured, deformed, cross-eye, blurry, (bad art, bad anatomy:1.4), blurred, text, watermark",
      "clip": [
        "50",
        1
      ]
  ...
  "46": {
    "inputs": {
      "lora_name": "neg4all_bdsqlsz_xl_V91.safetensors",
      "strength_model": 1,
      "model": [
        "52",
        0
...
async def t2i(prompt, res):
    ...
    # 设置文本描述
    req["6"]["inputs"]["text"] = str(prompt).strip().rstrip(",") + ", (masterpiece,best quality,ultra_detailed,highres,absurdres:1.2), year_2022, year_2023, year_2024, newest"
