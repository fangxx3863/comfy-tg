...
prompt_text = r'''
{
  ...
  "4": {
    "inputs": {
      "ckpt_name": "NoobAI-XL-v1.1.safetensors"
    },
...
async def t2i(prompt, res):
    ...
    # 设置文本描述
    req["6"]["inputs"]["text"] = str(prompt).strip().rstrip(",") + ", (very awa, masterpiece,best quality,ultra_detailed,highres,absurdres:1.2), year 2022, year 2023, year 2024, newest"
